使用 CloudFlare Worker 免费部署【from <https://github.com/EtherDream/jsproxy>】
...
复制 [webproxy.js](https://cdn.jsdelivr.net/gh/Arronlong/cloudflare@master/webproxy.js) 到左侧代码框，`Save and deploy`。如果正常，右侧应显示首页。
